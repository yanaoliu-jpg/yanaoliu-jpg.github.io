...
| 06 | Sea and Light | 海与光的诗 | 2026.03 | 珠海 |
...
第六组把这条线推到最纯：九张里七张有人，**全是背影和剪影，一张正面都没有**，
每个人都在看着什么（看鱼、看天顶漏下的光、看无人机、看海、看雕塑），他始终站在他们**身后**。
从"我站在外面看着一群人"变成"我站在他们背后，拍他们正在看的东西"。
...
上一次跑下来是 **296 项全过**（6 组：4 个屏幕尺寸 × 中英双版 + 14 个页面 + 14 条语言切换路径 + 12 条「下一组」链路）。
加一组之后记得改 `verify.js` 顶部的 `SLUGS`，其余会自己跟着长。

**换行是按宽高比排出来的，行不一定填满。** 六组时是 3+2+1：第二行到 68%，第三行只到 45%，
右边空着。那是定高换行的必然结果，不是 bug——第七组进来就变成 3+2+2。
